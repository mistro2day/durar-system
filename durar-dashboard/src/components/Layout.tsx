...
import { Home, FileText, Building2, Wrench, BarChart3, LogOut, Receipt, Settings as SettingsIcon, Shield, Users as UsersIcon, Hotel } from "lucide-react";
...
export default function Layout() {
  ...
  return (
    <div className="flex min-h-screen">
      <aside className="w-72 min-h-screen tivo-sidebar flex flex-col">
        ...
        <header className="tivo-topbar">
          <div className="tivo-container h-full flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <ThemeToggle />
              <div className="text-sm text-gray-600">مرحبا!</div>
              <div className="w-9 h-9 rounded-full bg-gradient-to-br from-indigo-500 to-purple-500" />
            </div>
          </div>
        </header>
        <main className="flex-1 p-6 md:p-8 tivo-container">
          <Outlet />
        </main>
      </div>
    </div>
